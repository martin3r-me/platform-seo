    ...
    private function getDetail(int $urlId, int $teamId): ToolResult
    {
        ...
        return ToolResult::success([
            'url' => [
                ...
                'referring_domains' => $url->referring_domains,
                'backlink_rank' => $url->backlink_rank,
                ...
                'llm_mentions' => $url->llm_mentions,
                'llm_ai_search_volume' => $url->llm_ai_search_volume,
                'llm_mentions_fetched_at' => $url->llm_mentions_fetched_at?->toIso8601String(),
